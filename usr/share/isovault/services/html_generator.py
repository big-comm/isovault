...
class HTMLGenerator:
    ...
    def generate_main_index(self, all_files: List[Dict]) -> str:
        ...
        # Generate HTML
        html = self._generate_html_header("BigCommunity ISO Repository")
    ...
    def generate_folder_index(self, folder_name: str, files: List[Dict]) -> str:
        ...
        html = self._generate_html_header(f"{folder_name} - BigCommunity ISO Repository")
...
<body>"""
    ...
    <div class="header">
        <div class="container">
            ...
            <p class="subtitle">Linux Distribution ISO Repository</p>
        </div>
    </div>
    
    <div class="container">
        <div class="stats">
            <strong>{total_isos} ISO files available</strong> | Updated: {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}
        </div>
"""
        ...
        body += """
        <div class="stats">
            <input type="text" id="searchInput" placeholder="Search ISOs..." style="
                width: 100%;
                max-width: 400px;
                padding: 1rem;
                border: none;
...
"""
        ...
        <div class="folder-section">
            <div class="empty-folder">No ISO files available yet</div>
        </div>
'''
        else:
...
"""
    ...
    <div class="container">
        <div class="breadcrumb">
            <a href="../">← Back to All Folders</a> / <strong>{folder_name}</strong>
        </div>
...
"""
        ...
        if grouped_files:
            ...
            body += '            <div class="empty-folder">No files in this folder</div>\n'
        ...
        if md5_info:
            ...
            card += f"""
                    <div class="md5-container">
                        <div class="md5-label">MD5 Checksum</div>
...
"""
    ...
    def _generate_html_footer(self) -> str:
        ...
        return f"""
    <div class="footer">
        <p>Generated by ISOVault | <a href="https://communitybig.org" style="color: rgba(255,255,255,0.9);">communitybig.org</a></p>
    </div>
